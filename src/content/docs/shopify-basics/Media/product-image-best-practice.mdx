...
description: Advice on the best way to create product imagery for your store.
sidebar:
  order: 1
---
...
As an online retailer, images are arguably the most important element involved in selling your products. High-quality imagery not only helps potential buyers make purchasing decisions, but also impacts how your site performs. Poorly optimised images can slow down your store and hurt conversions.

In this guide, I'll cover some key things to consider when uploading images to Shopify.
...
- Always optimise your images before uploading.
