...
**The fix:** Test your store on an actual mobile device before launch, not just your browser's mobile emulator. Walk through the full journey from homepage to product page to checkout and check that everything is usable on a small screen.
