...
Not all elements of the admin menu will be covered here as that is beyond the scope of this guide, however the items I want to focus on are:
...
**Content:**  
The Content section in Shopify has recently been updated and now includes **Metaobjects** (I'll dive into those later), **Files**, **Menus**, and **Blog Posts**.
...
- **Menus** allows you to manage your store’s navigation. Here, you can create and organise the links that appear in your site's main menu, footer, or any custom menus.
