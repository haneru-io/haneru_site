---
title: Resources
description: A curated list of tools, references, and repositories worth bookmarking.
sidebar:
  order: 1
---
...
The go-to editor for theme development. Free, fast, and has excellent extensions for Liquid syntax highlighting and formatting.

**[ImageOptim](https://imageoptim.com)** (macOS) / **[Pinga](https://css-ig.net/pinga)** (Windows)
Desktop apps for compressing images before they go anywhere near your theme. Unoptimised images are one of the most common and easily fixed performance problems on Shopify stores.
